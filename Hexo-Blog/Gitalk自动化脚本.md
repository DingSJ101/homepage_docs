...
![](https://s2.loli.net/2022/07/23/BZJvISCHeam4uKE.png)

生成一个token

![](https://s2.loli.net/2022/07/23/RQImzMbfPo7dS4D.png)
...
// 配置信息
const config = {
  username: 'DingSJ101', // GitHub repository 所有者，可以是个人或者组织。对应Gitalk配置中的owner
  repo: "blog_gitalk", // 储存评论issue的github仓库名，仅需要仓库名字即可。对应 Gitalk配置中的repo
  token: 'ghp_qN8ey1rv9jxxxxxxxxtQEt4nAp5Z4CBFoS', // 前面申请的 personal access token
